package com.indra.pedometer.activity;
...
import com.indra.pedometer.service.IStepService;
import com.indra.pedometer.service.IStepServiceCallback;
import com.indra.pedometer.service.StepDetector;
import com.indra.pedometer.service.StepService;
import com.indra.pedometer.utilities.MessageUtilities;
import com.indra.pedometer.R;

public class Langkahku extends Activity {

    private static final Logger logger = Logger.getLogger(Langkahku.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (stepServiceIntent == null) {
            ...
            extras.putInt("int", 1);
            stepServiceIntent = new Intent(Langkahku.this, StepService.class);
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            try {
                if (mService != null && mService.isRunning()) {
                    MessageUtilities.confirmUser(Langkahku.this, "Exit App without stopping LangkahKu?", yesExitClick, null);
                } else {
                    stop();
    ...
    private OnCheckedChangeListener startStopListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (isChecked && !serviceIsRunning) {
                ...
                MessageUtilities.confirmUser(Langkahku.this, "Stop Langkahku?", yesStopClick, noStopClick);
            }
        }
    };
